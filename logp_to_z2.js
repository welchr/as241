function logp_to_z2(logp) {
  // logp should be -log10(p-value)

  if (logp < 300) {
    // Use exact method when within the range of 64-bit floats
    return ninv((10 ** -logp) / 2) ** 2
  }
  else {
    ...
    // with ninv
    return (4.59884133027944 * logp ** 1) - 5.88085867031722
  }
}
